...
public class DateUtils {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 format 에 맞지 않는 경우.
     */
    public  String changeFormat(String s, String format, String toformat)
            throws ParseException {
        Date date = check(s, format);
        SimpleDateFormat formatter =
                new SimpleDateFormat(toformat, java.util.Locale.KOREA);
     ...
     *  @return toformat형태로 변경된 날짜를 표시하는 문자열
     */
    public  String changeFormat(Date date,  String toformat)
    {
    ...
    /**
     * @Method Name : changeFormatFromLong
     * @작성일 : 2016. 7. 21. 오전 9:53:59
     * @작성자 : martin
     * @변경이력 :
     * @Method 설명 :
     * @param val
     ...
     * @return
     */
    public  String changeFormatFromLong(long val,  String toformat){
     ...
     */
    public  Date check(String s, String format)
            throws ParseException {
        if (s == null)
     ...
     */
    public  Date getDateInstance(String s)
            throws ParseException {
        String format = "HH:mm";
     ...
     *                 <tt>false</tt> 날짜 형식이 맞지 않거나, 존재하지 않는 날짜일 때
     */
    public  boolean isValid(String s, String format) {
		/*
				if ( s == null )
     ...
     *
     */
    public  int whichDay(String s) throws ParseException {
     ...
     */
    public  int whichDay(String s, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 "yyyyMMdd" 형식에 맞지 않는 경우.
     */
    public  int daysBetween(String from, String to)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이  format 형식에 맞지 않는 경우.
     */
    public  int daysBetween(String from, String to, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 "yyyyMMdd" 형식에 맞지 않는 경우.
     */
    public  int timesBetween(String from, String to)
            throws ParseException {
     ...
     */
    public  int timesBetween(String from, String to, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  int minsBetween(String from, String to, String format)
            throws ParseException {
    ...
    public  int secendBetween(String from, String to, String format)
            throws ParseException {
    ...
    public  int mSecendBetween(String from, String to, String format)
            throws ParseException {
        ...
        return (int) (Math.round(duration / 100.0));
        // seconds in 1 day
    }
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String timesBetweenStr(String from, String to, String format)
            throws ParseException {
     ...
     */
    public  int monthsBetween(String from, String to)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  int monthsBetween(String from, String to, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  int ageBetween(String from, String to)
            throws ParseException {
     ...
     */
    public  int age(String birth) throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  int ageBetween(String from, String to, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  String addDays(String s, int day)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  String addDays(int day) throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  String addDays(int day, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String addDays(String s, int day, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String addTimes(String s, int time, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);
    ...
    public  String addMins(String s, int time, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);

        date.setTime(date.getTime() + ((long)  1000 * 60 * time));
        return formatter.format(date);
    }
    public  String addSecs(String s, int time, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);

        date.setTime(date.getTime() + ((long)  1000  * time));
        return formatter.format(date);
    }
    /**
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String addTimes( int time, String format)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  String addMonths(String s, int month) throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String addMonths(String s, int addMonth, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
     */
    public  String addYears(String s, int year)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String addYears(String s, int year, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
        Date date = check(s, format);
    ...
    public  String lastDayOfMonth(String src)
            throws ParseException {
     ...
     * @exception ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>format</code> 형식에 맞지 않는 경우.
     */
    public  String lastDayOfMonth(String src, String format)
            throws ParseException {
        SimpleDateFormat formatter =
                new SimpleDateFormat(format, java.util.Locale.KOREA);
     ...
     */
    public  String checkDateTime(String s) throws ParseException {
     ...
     * @throws ParseException 인자로 전달된 시각이 지정된 포멧("HH:mm" or "HH/mm" 에) 맞지 않거나 올바른 시간이 아닐경우 발생.
     */
    public  boolean isMiddleTime(String startTime,String endTime) throws ParseException
    {
    ...
    public String convertToDate(String time) throws Exception{
        Date date = new Date(time+"000");
     ...
     * @return
     */
    public String longConvertToDate(long time,String format){
    ...
    /**
     * @Method Name : newLongDate
     * @작성일 : 2016. 9. 1. 오후 1:02:17
     * @작성자 : martin
     * @변경이력 :
     * @Method 설명 :
     * @param format
     ...
     * @return
     */
    public long newLongDate(String format,String time){
        long ret = 0;
     ...
     * @return
     */
    public long newLongDateNano(String format,String time){
        long ret = 0;
     ...
     * @return
     */
    public String secConverterDate(String sec){
        int intSec = Integer.valueOf(sec);
        return (intSec / 3600) + ":" + (intSec % 3600 / 60) + ":" + (intSec % 3600 % 60);
    }
}